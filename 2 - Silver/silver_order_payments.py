...
tb_name = "olist_silver.order_payments"
...
df = spark.read.table("olist_bronze.order_payments") # leituira da delta table
...
# MAGIC
# MAGIC Aqui nessa table os dados já estão limpos e tratados. Só iremos escrever na camada silver
...
# MAGIC %sql
# MAGIC
# MAGIC select * from olist_bronze.order_payments
