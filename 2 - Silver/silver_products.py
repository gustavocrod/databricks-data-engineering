...
# MAGIC
# MAGIC Aqui nessa table os dados já estão limpos e tratados. só iremos armazenar a silver (nao precisa nem do product_category_name_translation)
...
# MAGIC %sql
# MAGIC
# MAGIC select * from olist_bronze.products
